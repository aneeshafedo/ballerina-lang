...
public class RemoteMethodCallActionNodeVisitor extends NodeVisitor {
    ...
    public RemoteMethodCallActionNodeVisitor() {
    }
    ...
    public void visit(RemoteMethodCallActionNode remoteMethodCallActionNode) {
        ...
        StatementNodeVisitor statementVisitor = new StatementNodeVisitor(clientName);
        NonTerminalNode parent = remoteMethodCallActionNode.parent().parent();

        while (statementVisitor.getServiceId() == null || Objects.equals(statementVisitor.getServiceId(), "")) { //isEmpty
